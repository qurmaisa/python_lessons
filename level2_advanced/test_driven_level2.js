 ...
 *
 * 💡 ПОДСКАЗКИ:
 * - Используйте charCodeAt() для получения кода символа
 * - Используйте String.fromCharCode() для обратного преобразования
 ...
 *
 * 💡 ПОДСКАЗКИ:
 * - Создайте массив булевых значений размером n + 1
 ...
 * - Соберите все числа, отмеченные как простые
 */
